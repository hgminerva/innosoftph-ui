...
declare module wijmo.chart.analytics {
    /**
     * Specifies the quartile calculation method of Box&Whisker chart.
     */
    ...
    /**
     * Represents a Box&Whsiker series of @see:wijmo.chart.FlexChart.
     *
     * The @see:BoxWhisker series is normally used to compare distributions between different sets of numerical data.
     */
    class BoxWhisker extends SeriesBase {
        ...
        /**
         * Gets or sets a value that determines the group width as a percentage for the Box&Whisker chart.
         *
         * The default value for this property is 0.8. The min value is 0 and max value is 1.
         */
        groupWidth: number;
        /**
         * Gets or sets a value that determines the gap width as a percentage for the Box&Whisker chart.
         *
         * The default value for this property is 0.1. The min value is 0 and max value is 1.
         */
        gapWidth: number;
        /**
        * Gets or sets a value that determines whether to show the mean line for the Box&Whisker chart.
         */
        ...
        * Gets or sets a value that specifies the style for the mean line.
        ...
        meanLineStyle: any;
        /**
        * Gets or sets a value that determines whether to show the mean marker for the Box&Whisker chart.
         */
        ...
        * Gets or sets a value that specifies the style for the mean marker.
        ...
        meanMarkerStyle: any;
        /**
        * Gets or sets a value that determines whether to show the inner points for the Box&Whisker chart.
         */
        showInnerPoints: boolean;
        /**
        * Gets or sets a value that determines whether to show the outliers for the Box&Whisker chart.
         */
...
declare module wijmo.chart.analytics {
    ...
    /**
     * Represents an ErrorBar series of @see:wijmo.chart.FlexChart.
     *
     * The @see:ErrorBar series helps you see margins of error and standard deviations at a glance.
    ...
    class ErrorBar extends Series {
        ...
        constructor(options?: any);
        private _initProperties(o);
        getDataRect(currentRect?: Rect): Rect;
         ...
         * If errorAmount is ErrorAmount.Custom, the value property is an object of minus/plus value or an array of minus/plus value.
