...
var ReportComponent = (function () {
    ...
    function ReportComponent(reportService, router, toastr, vRef, slimLoadingBarService) {
        ...
        this.fliterReportStatusArray = ['ALL', 'OPEN', 'CLOSE', 'DONE', 'WAITING FOR CLIENT', 'CANCELLED', 'FOR CLOSING'];
        ...
        this.fliterReportSummaryStatusArray = ['ALL', 'OPEN', 'CLOSE', 'DONE', 'WAITING FOR CLIENT', 'CANCELLED', 'FOR CLOSING'];
